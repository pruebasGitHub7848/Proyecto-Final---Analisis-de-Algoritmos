...
import NaivLoopUnrollingTwo.Caso1_Matri16x16;

public class ClaseMultiplicadoraNaviOnArray {
	
	// Ruta del archivo donde se guardará el tiempo de ejecución
    private static final String RUTA_ARCHIVO = "src\\Resources\\TiemposDeEjecucion\\TiempoDeEjecucionNaivOnArray.txt";
	...
	public static void main(String[] args, long[][] matrizA, long[][] matrizB, String nombreCaso) {
		...
		long[][] resultado = multiplicarMatricesNaive(matrizA, matrizB);
	...
	//Método para multiplicar dos matrices usando el algoritmo Naive
	public static long[][] multiplicarMatricesNaive(long[][] matrizA, long[][] matrizB) {
